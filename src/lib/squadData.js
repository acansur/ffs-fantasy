...
// pts: pozitif sayı → yeşil (işaretsiz), negatif sayı → kırmızı (- ile),
// '×2' → sarı (kaptan bonusu). scoring.js motoruyla aynı değerler.
export const SCORING = {
  Genel: [
    { label: 'Oynama süresi (60+ dk)', pts: 2 },
    { label: 'Oynama süresi (1-59 dk)', pts: 1 },
  ...
  Kaleci: [
    ...
    { label: 'Her 2 yenilen gol', pts: -1 },
    { label: 'Her 3 kurtarış', pts: 2 },
    { label: 'Penaltı kurtardı', pts: 5 },
  ],
  Defans: [
    { label: 'Gol', pts: 6 },
    { label: 'Asist', pts: 4 },
    { label: 'Clean sheet', pts: 4 },
    { label: 'Her 2 yenilen gol', pts: -1 },
    { label: 'Her 3 kilit pas', pts: 1 },
    { label: 'Her 3 top kapma', pts: 2 },
    { label: 'Her 4 ikili mücadele', pts: 1 },
    { label: 'Her 3 faul', pts: -1 },
  ],
  'Orta Saha': [
    { label: 'Gol', pts: 5 },
    { label: 'Asist', pts: 3 },
    { label: 'Clean sheet', pts: 1 },
    { label: 'Her 3 kilit pas', pts: 1 },
    { label: 'Her 3 top kapma', pts: 2 },
    { label: 'Her 4 ikili mücadele', pts: 1 },
    { label: 'Her 2 dribling', pts: 1 },
    { label: 'Her 2 isabetli şut', pts: 1 },
    { label: 'Her 3 faul', pts: -1 },
  ],
  Forvet: [
    { label: 'Gol', pts: 4 },
