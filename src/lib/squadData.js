...
export const SCORING = {
  ...
  Kaleci: [
    ...
    { label: '2 gol yenme', pts: -1 },
    { label: '3 kurtarış', pts: 2 },
  ...
  Defans: [
    ...
    { label: 'Clean sheet', pts: 4 },
    { label: '2 gol yenme', pts: -1 },
    { label: '3 kilit pas', pts: 1 },
    { label: '3 top kapma', pts: 2 },
    { label: '4 ikili mücadele', pts: 1 },
    { label: '3 faul', pts: -1 },
  ],
  'Orta Saha': [
    { label: 'Gol', pts: 5 },
    ...
    { label: '3 top kapma', pts: 2 },
    { label: '4 ikili mücadele', pts: 1 },
    { label: '2 dribling', pts: 1 },
    { label: '2 isabetli şut', pts: 1 },
    { label: '3 faul', pts: -1 },
  ],
  Forvet: [
    { label: 'Gol', pts: 4 },
